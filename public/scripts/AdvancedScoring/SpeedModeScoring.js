// AdvancedSpeedModeScoring.js

export class AdvancedSpeedModeScoring {
  ...
  // Get stars based on advanced thresholds, scaled by interval speed
  // For 1s interval (base): ≤2000pts = 1★, 2000-3500pts = 2★, 3500+pts = 3★
  getStars() {
    const points = this.getTotalPoints();
    
    // Scale thresholds based on interval speed
    // Base thresholds for 1s (1000ms) interval
    const baseThreshold1 = 2000;
    const baseThreshold2 = 3500;
