...
// Listener for transposition changes: log fingering for current note
// Replace 'C1.png' with your actual note image key if needed
const DEMO_NOTE_IMAGE = 'C1.png';
document.addEventListener('transposition:change', (e) => {
  const { instrument, key } = e.detail || {};
  const fingering = getFingering(instrument, DEMO_NOTE_IMAGE, key);
  console.log(`Fingering for ${instrument} trumpet, key ${key}, note ${DEMO_NOTE_IMAGE}:`, fingering);
});
